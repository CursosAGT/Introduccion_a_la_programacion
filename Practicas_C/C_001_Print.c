...
// Ej 001_2
	printf ("\nInicio ej001_2\n");
	char cadena [] = "es hora de trabajar grupo 2020";
	printf ("\nLa Cadena original es : %s", cadena);
	int largo_cadena =  sizeof cadena ;
	printf( "\nTaman-io de la cadena: %i bytes\n\n\n", largo_cadena );
...
// Ej 001_3
	...
	printf( "%%8.2f           taman-io total de 8 digitos, con dos decimales\n");
	printf( "%%.*f”',x,d)     taman-io predeterminado,x numeros decimales\n");
	printf( "%%*.*f”,x,y,d)   taman-io igual a x, y numeros decimales\n");
...
Toda marca, por tanto, comienza por el símbolo “%” y termina con su tipo. Cada uno de los nombres (parameter, flags, width, precision, length y type) representa un conjunto de valores posibles que se explican a continuacion.
 *
...
#						Formato alternativo. Para reales se dejan ceros al final y se imprime siempre la coma. Para números que no están en base 10, se an-iade un prefijo denotando la base.

Width				Descripcion
número 					Taman-io del ancho del campo donde se imprimirá el valor.
...
número 					Taman-io de la parte decimal para números reales. Número de caracteres a imprimir para cadenas de texto
...
%d, %i					Conversion decimal con signo de un entero
%x, %X					Conversion hexadecimal sin signo
%p						Direccion de memoria (puntero)
%e, %E					Conversion a coma flotante con signo en notacion científica
