...
int main()
{
	...
	printf("\nIntroduce un numero : ");
	scanf("%i%*c", &valor_1);
	printf("\nValor original=%d en main antes de llamar a la funcion modificar", valor_1);
	modificar(valor_1);
	printf("\nvalor=%d en main despues de llamar a la funcion modificar", valor_1);
	retorno=modificar_retorno(valor_1);
	printf("\nvalor=%d en main despues de llamar a la funcion modificar_retorno", retorno);
	modificar_punteros(&valor_1);
	printf("\nvalor=%d en main despues de llamar a la funcion modificar_punteros", valor_1);
...
void modificar_punteros(int *valor_c)//puntero  o direccion de memoria
	{
	printf("\n+------------------------+");
	printf("\n|  DENTRO DE LA FUNCION  |");
	printf("\n|    modificar_punteros   |");
