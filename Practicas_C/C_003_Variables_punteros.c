...
// Ej 003_P_01
//Este codigo sería erroneo y daría una violacion de segmento:
/*
char *puntero;
scanf ("%c", puntero);
...
*/
	...
	scanf ("%c", puntero);
//En este codigo, al scanf le pasamos el puntero en sí. El puntero es una variable, como bien se ha dicho anteriormente, que contiene una direccion de memoria, por tanto, no es necesario el uso de & para pasarle la direccion de memoria a scanf. Anteriormente hemos tenido que reservar un espacio de memoria con malloc(), que se verá su uso más adelante.
